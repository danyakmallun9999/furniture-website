            ...
            <div class="flex items-center space-x-4">
                <div>
                    <h2 class="text-2xl font-bold text-slate-900 dark:text-white leading-tight">
                        Edit Transaksi - {{ $invoice->invoice_number }}
                    </h2>
                    ...
                    <form action="{{ route('invoices.update', $invoice->id) }}" method="POST" enctype="multipart/form-data" x-data="invoiceForm(
                        ...
                        <div class="p-6 border-b border-slate-200 dark:border-slate-700">
                            <div class="flex items-center space-x-3">
                                ...
                                <div>
                                    <h3 class="text-lg font-bold text-slate-900 dark:text-white">Edit Transaksi #{{ $invoice->invoice_number }}</h3>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div>
                                    ...
                                    <select id="type" name="type"
                                        class="w-full px-4 py-3 border border-slate-200 dark:border-slate-600 rounded-xl bg-white dark:bg-slate-800 text-slate-900 dark:text-white focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200"
                                        required>
                                        <option value="kredit" {{ old('type', $invoice->type) == 'kredit' ? 'selected' : '' }}>Kredit (Pemasukan)</option>
                                        <option value="debit" {{ old('type', $invoice->type) == 'debit' ? 'selected' : '' }}>Debit (Pengeluaran)</option>
                                    </select>
                                    @error('type')
                                        <p class="mt-2 text-sm text-red-600 dark:text-red-400 flex items-center">
                                            <i data-lucide="alert-circle" class="w-4 h-4 mr-1"></i>
                        ...
                        <div class="p-6">
                            <div class="flex items-center justify-between">
                                <div>
                                    ...
                                    <p class="text-sm text-slate-600 dark:text-slate-400">Total keseluruhan transaksi</p>
                                </div>

                ...
                <div class="relative bg-white dark:bg-slate-900 rounded-2xl shadow-xl hover:shadow-2xl transition-all duration-300 border border-slate-200 dark:border-slate-700">
                    ...
                    <div class="p-6 border-b border-slate-200 dark:border-slate-700">
                        <div class="flex items-center space-x-3">
                            ...
                            <div>
                                <h3 class="text-lg font-bold text-slate-900 dark:text-white">Form Kategori Baru</h3>
                                <p class="text-sm text-slate-600 dark:text-slate-400">Isi informasi kategori di bawah ini</p>
                            </div>
                        </div>
                    </div>

            ...
            <div class="flex items-center space-x-4">
                <div>
                    ...
                    <p class="text-sm text-slate-600 dark:text-slate-400 mt-1">
                        Tambahkan produk mebel baru ke katalog
                    </p>
                </div>
            </div>
        </div>
                    ...
                    <form action="{{ route('products.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="p-6 border-b border-slate-200 dark:border-slate-700">
                            <div class="flex items-center space-x-3">
                                ...
                                <div>
                                    <h3 class="text-lg font-bold text-slate-900 dark:text-white">Form Produk Baru</h3>
                                    <p class="text-sm text-slate-600 dark:text-slate-400">Isi informasi produk di bawah ini</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="p-6">
                            ...
                            <div class="mb-8">
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    ...
                                    <div>
                                        ...
                                        <input type="text" id="motif" name="motif" value="{{ old('motif') }}"
                                            class="w-full px-4 py-3 border border-slate-200 dark:border-slate-600 rounded-xl bg-white dark:bg-slate-800 text-slate-900 dark:text-white placeholder-slate-500 dark:placeholder-slate-400 focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200"
                            ...
                            <div class="mb-8">
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    ...
                                    <div>
                                        ...
                                        <input type="text" id="wood_type" name="wood_type" value="{{ old('wood_type') }}"
                                            class="w-full px-4 py-3 border border-slate-200 dark:border-slate-600 rounded-xl bg-white dark:bg-slate-800 text-slate-900 dark:text-white placeholder-slate-500 dark:placeholder-slate-400 focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200"
                                    ...
                                    <div>
                                        <label for="main_image" class="block text-sm font-semibold text-slate-700 dark:text-slate-300 mb-2">
                                            <div class="flex items-center space-x-2">
                                                ...
                                                <span>Gambar Utama (Opsional)</span>
                                            </div>
                                        </label>
                            ...
                            <div class="flex items-center justify-between pt-6 border-t border-slate-200 dark:border-slate-700">
                                ...
                                <button type="submit"
                                        class="group flex items-center px-8 py-3 bg-gradient-to-r from-green-500 to-emerald-600 hover:from-green-600 hover:to-emerald-700 text-white font-semibold rounded-xl shadow-lg hover:shadow-xl transform hover:-translate-y-0.5 transition-all duration-200">

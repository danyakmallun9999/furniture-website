{{-- resources/views/public/coming-soon.blade.php --}}
...
<x-guest-layout>
    <section
        ...
        <div class="relative z-10 max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 text-center animate-fade-in">
            <p class="text-6xl sm:text-7xl lg:text-8xl font-extrabold text-gray-900 mb-4 leading-none">Segera Hadir</p>
            <h1 class="text-3xl sm:text-4xl font-bold text-gray-800 mb-4">Situs Kami Sedang Dalam Pengembangan</h1>
            <p class="text-lg text-gray-600 mb-8">
                Kami sedang bekerja keras untuk memberikan Anda pengalaman terbaik. Nantikan pembaruan menarik dari
                kami!
            </p>
            <a href="{{ url('/') }}"

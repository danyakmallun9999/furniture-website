...
<x-guest-layout>
    <section
        ...
        <div class="relative z-10 max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 text-center animate-fade-in">
            <p class="text-6xl sm:text-7xl lg:text-8xl font-extrabold text-gray-900 mb-4 leading-none">404</p>
            <h1 class="text-3xl sm:text-4xl font-bold text-gray-800 mb-4">Halaman Tidak Ditemukan</h1>
            <p class="text-lg text-gray-600 mb-8">
                Maaf, halaman yang Anda cari tidak ada. Mungkin Anda salah mengetik alamatnya atau halaman tersebut
                sudah dipindahkan.
            </p>
            <a href="{{ url('/') }}"
